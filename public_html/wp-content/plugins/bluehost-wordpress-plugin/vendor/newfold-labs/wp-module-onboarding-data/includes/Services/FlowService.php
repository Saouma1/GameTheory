...
class FlowService {
	...
	/**
	 * Fetches the Chapter data containing the eligible and completed chapters.
	 *
	 * @return array
	 */
	public static function get_chapter_data() {
		$data = self::get_data();
		return isset( $data['data']['chapters'] ) ? $data['data']['chapters'] : array();
	}

	/**
	 * Fetches the Top Priority selected during Onboarding.
	 *
	 * @return false|string
	 */
